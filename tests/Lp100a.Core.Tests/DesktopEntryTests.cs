...
{
    private const string Exec = "/home/ab0r/.local/share/lp100a-monitor/Lp100aMonitor";

    [Fact]
    public void HasTheRequiredKeys()
    {
        var s = DesktopEntry.Build("LP-100A Monitor", Exec);
        Assert.StartsWith("[Desktop Entry]", s);
        Assert.Contains("Type=Application", s);
        Assert.Contains("Name=LP-100A Monitor", s);
    ...
    public void APathWithSpacesSurvivesQuoting()
    {
        ...
        var p = "/home/ab0r/.local/share/LP-100A Monitor/Lp100aMonitor";
    ...
    public void TheIconLineIsOmittedRatherThanLeftEmpty()
    {
        ...
        var s = DesktopEntry.Build("LP-100A Monitor", Exec, iconPath: null);
    ...
    {
        var icon = "/home/ab0r/.local/share/icons/hicolor/256x256/apps/lp100a-monitor.png";
        Assert.Contains($"Icon={icon}", DesktopEntry.Build("LP-100A Monitor", Exec, iconPath: icon));
    }
    ...
    {
        var s = DesktopEntry.Build("LP-100A Monitor", Exec, categories: ["Network"]);
        Assert.Contains("Categories=Network;\n", s);
    }

    [Fact]
    public void TheWindowClassIsDeclaredSoTheDockMatchesTheWindow()
    {
    ...
    {
        var s = DesktopEntry.Build("LP-100A Monitor", Exec, iconPath: "/tmp/i.png", comment: "Wattmeter");
