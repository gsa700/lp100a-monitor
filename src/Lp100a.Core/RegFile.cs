...
/// a spawn that silently didn't take from one that did — which is the shape of the installed-apps
/// entry that was written, reported success, and then wasn't there (0.9.18-beta, 2026-07-28). One
/// import is also cheap enough to repeat on every launch, which is what makes a lost entry self-heal.
///
/// Ported from the W2 monitor. The Linux analogue is <see cref="DesktopEntry"/> — same reasoning,
/// same reason it is tested.
/// </summary>
