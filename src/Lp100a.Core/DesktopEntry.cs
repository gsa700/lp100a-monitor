...
public static class DesktopEntry
{
    ...
    public const string FileName = "lp100a-monitor.desktop";

    /// <summary>
    /// Window class Avalonia reports on X11, so the running window associates with this entry
    /// (correct icon in the dock/taskbar rather than a generic placeholder).
    /// </summary>
    public const string WindowClass = "Lp100aMonitor";
